...
class ClipMapper:
    ...
    def __init__(self, enable_image, enable_text, enable_metadata, use_mclip, clip_model, checkpoint, use_jit, mclip_model):
        self.enable_image = enable_image
        self.enable_text = enable_text
        self.enable_metadata = enable_metadata
        self.use_mclip = use_mclip
        self.device = "cuda" if torch.cuda.is_available() else "cpu"
        model, _ = load_clip(clip_model, use_jit, checkpoint)
